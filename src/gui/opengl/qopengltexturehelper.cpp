...
QOpenGLTextureHelper::QOpenGLTextureHelper(QOpenGLContext *context)
{
    ...
    if (context->isOpenGLES() && context->hasExtension(QByteArrayLiteral("GL_OES_texture_3D"))) {
        ...
        TexImage3D = ::GLES2TexImage3D;
        TexSubImage3D = ::GLES2TexSubImage3D;
        CompressedTexImage3D = ::GLES2CompressedTexImage3D;
        CompressedTexSubImage3D = ::GLES2CompressedTexSubImage3D;
#else
        // OpenGL 1.2
